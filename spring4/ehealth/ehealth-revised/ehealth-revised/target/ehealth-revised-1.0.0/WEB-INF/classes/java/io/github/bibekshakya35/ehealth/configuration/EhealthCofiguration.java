...
@EnableWebMvc
/**
 * @EnableWebMvc annotation in case of REST detect the the existence of jakson
 * and jaxb 2 on the class path abd automatically creares and register default
 * json and xml converters. this annotation is equivalent ti the xml version of
