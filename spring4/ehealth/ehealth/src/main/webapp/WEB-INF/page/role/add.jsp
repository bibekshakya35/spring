    ...
    <body>
        <div class="row">
            <div class="col-sm-9 col-md-9">
                ...
                <c:url value="/role/save" var="save"/>
                <form:form id="addRole" modelAttribute="role" action="${save}" method="post">
                            ...
                            <td> 
                                <c:forEach items="${group}" var="m" varStatus="i">
                                    ...
                                    <c:forEach items="${m.value}" var="p">
                                        <form:checkbox value="${p.code}" path="permissions" label="${p.code}"/> 
                                    </c:forEach>
                                </c:forEach>
                            </td>
