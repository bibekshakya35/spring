    ...
    <body>
        <div class="row">
            <div class="col-sm-9 col-md-9">
                ...
                <c:url value="/group/editGroup/{group.code}" var="edit"/>
                <form:form id="addgroupcode" modelAttribute="group" action="${edit}">
                ...
                <div class="col-sm-3 col-md-3">
                    <fieldset>
                        ...
                        <div class="form-group" style="margin-bottom: 100px;">
                            <button class="btn btn-primary btn-lg col-sm-offset-3" type="submit" name="addPermission" id="btnedit"><i class="glyphicon glyphicon-save"></i> Save / Edit</button>
                        </div>
