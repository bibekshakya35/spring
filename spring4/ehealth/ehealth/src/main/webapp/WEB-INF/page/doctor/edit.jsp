            ...
            <div class="row" style="overflow: scroll;">
                ...
                <div class="row">
                    <div class="col-sm-offset-2" >
                        <c:url value="/doctor/editForm/${doctor.userName}" var="save"/>
                        <form:form cssClass="form-horizontal" method="POST" modelAttribute="doctor" commandName="doctor" action="${save}" enctype="multipart/form-data">
                            ...
                            <div>
                                <label class="control-label label-info"> Doctor Type</label>
                            </div>
                            <div class="form-group">
                                <label for="doctorType" class="col-sm-3 control-label">Doctor Spec</label>
                                <div class="col-sm-9">
                                    <form:input path="doctorType.code"/>                                       
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="doctorTypeDescription" class="col-sm-3 control-label">Description</label>
                                <div class="col-sm-9">
                                    <form:input path="doctorType.description"/>                                       
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="bodyPart" class="col-sm-3 control-label">Body Part</label>
                                <div class="col-sm-9">
                                    <form:input path="doctorType.bodyPart"/>                                       
                                </div>
                            </div>
